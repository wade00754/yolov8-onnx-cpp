...
int main() {
    std::string img_path = "C:\\Users\\Kirschblute\\Desktop\\PG\\yolov8-onnx-cpp\\images\\000000000143.jpg";
    ...
    //  clion:
    const std::string& modelPath = "C:\\Users\\Kirschblute\\Desktop\\PG\\yolov8-onnx-cpp\\checkpoints\\yolov8n-seg.onnx";  // pose
